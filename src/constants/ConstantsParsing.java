...
public class ConstantsParsing {
	...
	public static boolean onlyNounOrNE = true;//False for TACL experiments and LevyProcessing, true for NC. In order to remove pronouns, etc in case of GG. 
	public static final boolean lemmatizePred = true;// eaten.might.1 => eat.might.1// Must be true for normal entailment graphs
	public static final boolean normalizePredicate = true;// (eat.2, eat.might.1) => (eat.1,eat.2). was false for TACL experiments. It shouldn't change the results, though, since
