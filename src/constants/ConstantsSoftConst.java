...
public class ConstantsSoftConst {
	...
	public static double lmbda = 0.00005;// lmbda for L1 regularization //.01 for ALL TACL experiments
...
//	public static String tPropSuffix = "_tPropC_i4_1_.3_0_mr100_thr0.txt"; // NC binc experiments
//	public static String tPropSuffix = "_tPropC_i4_1.5_.3_0_thr0_mr100.txt";
	public static String tPropSuffix = "_tPropC_i4_1.5_.3_0.00005_thr0.00005_divmax.txt";
	...
	public static boolean applyMaxRankInIters = false;//false for TACL experiments, true for MC experiments.
	public static int minEdgesToApplyMaxRankInIters = -1; //if allEdgesProp < 300M => act as if applyMaxRankInIters = false. Always false
//	public static String compatiblesPath0 = "../../python/gfiles/ent/compatibles_all.txt";
	public static boolean divideByMax = true;//False for all TACL experiments.
}
