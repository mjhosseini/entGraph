...
//	public static String tPropSuffix = "_tPropC_i4_1_.3_0_mr100_thr0.txt"; // NC binc experiments
	public static String tPropSuffix = "_tPropC_i4_1.5_.3_0.00005_thr0.00005.txt";
	...
	public static boolean applyMaxRankInIters = false;//false for TACL experiments
	public static int minEdgesToApplyMaxRankInIters = -1; //if allEdgesProp < 300M => act as if applyMaxRankInIters = false
